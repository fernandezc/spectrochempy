...
class SpectroChemPy(Application):
    ...
    logging_config = tr.Dict(
        {
            "handlers": {
                "rotatingfile": {
                    ...
                    "level": "DEBUG",
                    "filename": f"{get_log_dir()}/spectrochempy.log",
                    "maxBytes": 262144,
                    "backupCount": 5,
                },
                "string": {
    ...
    # # Command line interface (not used for the moment)
    # aliases = dict(
    ...
    #         "tr.Set NO DISPLAY mode to true - no graphics at all",
    #     ),
    #     reset_config=(
    ...
    def start(self, configurables=None):
        ...
        from spectrochempy.utils.file import DataDir
