...
If an offset is defined then the actual roi below is displayed accordingly (*see actual roi values below*).
            ...
            dbc.InputGroup(
                [
                    dbc.InputGroupText(id="x-roi"),
                    dbc.InputGroupText(id="x-roi-units"),
                ],
                size="sm",
            ),
            dbc.InputGroup(
            ...
            dbc.InputGroup(
                [
                    dbc.InputGroupText(id="y-roi"),
                    dbc.InputGroupText(id="y-roi-units"),
                ],
                size="sm",
            ),
            dbc.InputGroup(
...
masks.
            ...
            dbc.InputGroup(
                [
                    dbc.InputGroupText("Masks", id="masks"),
                    dbc.Button(
                        "Select region",
                        color="secondary",
                        outline=True,
