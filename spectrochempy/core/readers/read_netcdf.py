...
def read_netcdf(*paths, **kwargs):
    ...
    *paths : str, pathlib.Path object, list of str, or list of pathlib.Path objects, optional
        ...
        *e.g.,* ( **[** *file1, file2, ...* **]**, **kwargs *)*
        ...
        except if `merge` is set to False. If a source is not provided (i.e. no `filename`,
        nor `content`), a dialog box will be opened to select files.
    **kwargs
    ...
    directory : str, optional
        From where to read the specified `filename`. If not specified, read in the default
        ``datadir`` specified in SpectroChemPy Preferences.
    merge : bool, optional
