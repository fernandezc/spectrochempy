...
def _read_spa(*args, **kwargs):
    ...
    if return_ifg is None:
        ...
        if return_ifg == "sample":
            ...
            default_description = (
                f"# Omnic name: {spa_name} : background IFG\n"
...
def _readbtext(fid, pos, size):
    # Read some text in binary file of given size.
    # If size is None, the txt is read until b\0\ is encountered.
