...
<div class='alert alert-info'>
    <b>Note</b>
    The attributes comment**, **title** and **source** where added in version 0.4.0 in replacement of **description**, **title** and **origin**, respectively. For backward compatibility, the previous attributes are still accessible but issue a deprecated warning when used.
</div>
