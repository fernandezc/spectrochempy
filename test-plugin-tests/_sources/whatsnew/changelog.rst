...
- Updated CI test selection to include ``spectrochempy-nmr``,
  ``spectrochempy-hypercomplex``, ``spectrochempy-iris``, and
  ``spectrochempy-carroucell`` in the full CI plugin targets.
