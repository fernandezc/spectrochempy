...
_LOAD = OperationSpecification(
    ...
    parameters=[
        ...
        ParameterSpec(
            ...
            type="int",
            default=None,
            description="Selected object index for multi-object reader outputs",
        ),
        ParameterSpec(
            name="selected_name",
            type="str",
            default=None,
            description="Selected object name for multi-object reader outputs",
        ),
        ParameterSpec(
            name="source_object_count",
            type="int",
            default=None,
            description="Number of objects returned by the original reader",
        ),
    ],
    side_effects=[],
    category="io",
...
_INTEGRATE = OperationSpecification(
    ...
    parameters=[
        ...
        ParameterSpec(
            ...
            type="str",
            default="x",
            description="Dimension to integrate along",
        ),
    ],
    side_effects=[],
    category="analysis",
