...
from spectrochempy.application import get_loglevel, set_loglevel, warning_
...
# TODO: This is not working since lazy_imports ???
# def test_magic_addscript(ip):
#     if ip is None:
#         warning_("ip is None - pss this test ")
#         return
#
#     from spectrochempy.ipython.magics import SpectroChemPyMagics
#
...
#     x = ip.run_line_magic("addscript", "-p project -o prefs -n preferences 3")
#
#     print("x", x)
...
#         "print(scp.preferences.available_styles)"
#     )
#
#     print("result\n", x.result)
